...
def main():
    ...
    parser.add_argument("--model_path", type=str,
                        default="/datanfs4/xinzheyu/project/models/Qwen3-4B-merged-for-vllm",
                        help="合并 LoRA 后的模型路径")
    ...
    parser.add_argument("--output_file", type=str,
                        default="/datanfs4/xinzheyu/project/overthinking_Dr.Dai/code/results/qwen3/eval_results_vllm.json",
                        help="保存生成结果的文件路径")
    ...
    for i, item in enumerate(test_data):
        ...
        prompt_templated = tokenizer.apply_chat_template(messages, add_generation_prompt=True, tokenize=False, enable_thinking=False)
